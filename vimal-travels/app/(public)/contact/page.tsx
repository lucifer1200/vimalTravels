            ...
            <ScrollReveal direction="left">
              <div>
                ...
                <div className="space-y-4 mb-8">
                  {[
                    { icon: MapPin, label: "Head Office — Mathikere", content: "5, Vimal Shopping Complex, MS Ramaiah Rd, opp. divya msr gateway, Gokula Extension, Mathikere, Bengaluru, Karnataka 560054", href: undefined },
                    { icon: MapPin, label: "Branch — New BEL Road", content: "1st Floor, 17, New BEL Rd, opp. to Printo, next to Bata showroom, AGS Layout, R.M.V. 2nd Stage, Bengaluru, Karnataka 560094", href: undefined },
