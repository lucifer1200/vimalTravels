...
const domesticPackages = [
  { title: "Kashmir Paradise",   duration: "6N / 7D", price: "₹24,999", highlights: ["Dal Lake Shikara Ride", "Gulmarg Snow & Gondola", "Pahalgam Valley", "Sonamarg Glacier"], image: "https://images.unsplash.com/photo-1566837945700-30057527ade0?w=800&q=85",   tag: "Most Popular" },
  { title: "Kerala Backwaters",  duration: "5N / 6D", price: "₹18,999", highlights: ["Alleppey Houseboat Stay", "Munnar Tea Hills", "Ayurvedic Spa", "Cochin Heritage Walk"], image: "https://images.unsplash.com/photo-1593693411515-c20261bcad6e?w=800&q=85",  tag: "Family Favourite" },
  ...
  { title: "Rajasthan Royal",    duration: "7N / 8D", price: "₹28,999", highlights: ["Jaipur Pink City", "Udaipur Lake Palace", "Jaisalmer Desert Safari", "Jodhpur Blue City"], image: "https://images.unsplash.com/photo-1524492412937-b28074a5d7da?w=800&q=85",   tag: "Heritage Tour" },
  { title: "Andaman Islands",    duration: "5N / 6D", price: "₹32,999", highlights: ["Radhanagar Beach", "Scuba Diving & Snorkeling", "Neil Island", "Glass Bottom Boat"], image: "https://images.unsplash.com/photo-1586861635167-e5223aadc9fe?w=800&q=85",   tag: "Beach Paradise" },
...
const internationalPackages = [
  { title: "Vietnam Explorer",  duration: "5N / 6D", price: "₹35,999", highlights: ["Ha Long Bay Cruise", "Hoi An Old Town", "Hanoi Street Food", "Cu Chi Tunnels"], image: "https://images.unsplash.com/photo-1528360983277-13d401cdc186?w=800&q=85", tag: "New Destination" },
  ...
  { title: "Bali Serenity",     duration: "5N / 6D", price: "₹55,999", highlights: ["Ubud Rice Terraces", "Tanah Lot Temple", "Kuta Beach Sunset", "Monkey Forest"], image: "https://images.unsplash.com/photo-1537996194471-e657df975ab4?w=800&q=85", tag: "Honeymoon Special" },
  { title: "Thailand Adventure", duration: "5N / 6D", price: "₹38,999", highlights: ["Bangkok Temples", "Pattaya Beach", "Floating Markets", "Coral Island"], image: "https://images.unsplash.com/photo-1506665531195-3566af2b4dfa?w=800&q=85", tag: "Group Favourite" },
  { title: "Maldives Luxury",   duration: "4N / 5D", price: "₹65,999", highlights: ["Water Villa Stay", "Snorkeling & Diving", "Private Beach Access", "Dolphin Cruise"], image: "https://images.unsplash.com/photo-1573843981267-be1999ff37cd?w=800&q=85", tag: "Luxury" },
  { title: "Malaysia Explorer", duration: "5N / 6D", price: "₹44,999", highlights: ["Petronas Towers", "Langkawi Island", "Genting Highlands", "Batu Caves"], image: "https://images.unsplash.com/photo-1596422846543-75c6fc197f07?w=800&q=85", tag: "Budget Friendly" },
];
          ...
          <ScrollReveal direction="up">
            <div className="max-w-2xl">
              ...
              <div className="flex gap-8 mt-8">
                {[["6+", "Domestic Destinations"], ["6+", "International Destinations"], ["19+", "Years of Expertise"]].map(([val, label]) => (
                  <div key={label}>
